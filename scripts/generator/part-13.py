harset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Page not found | DealershipCore</title><link rel="stylesheet" href="/assets/styles.css"></head><body><main class="hero"><div class="narrow text-center"><div class="eyebrow">404</div><h1>This page is not in the pipeline.</h1><p class="lead">The link may have moved or the page may not exist.</p><a class="btn btn-primary" href="/">Return to DealershipCore</a></div></main></body></html>''', encoding='utf-8')

# favicon
(ROOT/'favicon.svg').write_text('''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#2878ff"/><stop offset="1" stop-color="#67e8f9"/></linearGradient></defs><rect width="64" height="64" rx="16" fill="#0d131e"/><path d="M17 18h25v7H17zm0 11h18v7H17zm0 11h25v7H17z" fill="#fff"/><rect x="43" y="18" width="6" height="29" rx="3" fill="url(#g)"/></svg>''', encoding='utf-8')
